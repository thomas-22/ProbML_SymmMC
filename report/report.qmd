...
\begin{figure}[H]
  ...
  \caption{Partial dependence for \texttt{airfoil\_member02\_canon}: posterior samples and 90\,\% credible band widening where data variability is highest.}
...
\begin{figure}[H]
  ...
  \caption{Partial dependence for \texttt{airfoil\_member03\_canon}: posterior samples and 90\,\% credible band widening where data variability is highest.}
...
\begin{figure}[H]
  ...
  \caption{Partial dependence for \texttt{airfoil\_member04\_canon}: posterior samples and 90\,\% credible band widening where data variability is highest.}
